export default function mdsdpcdigiinputD(){
...
newtextheader('pg3o19', 'PG 7 OF 19', 'bluef', 'right')
//header and page data block
...
newtext('mdsdpcdigi', 'mdsdpcdigihead', 'INSERT D', 'center', 'bluef')
...
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'B10', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'B11', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'INACTIVE', 'amberf', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'C05', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'C06', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi1', '', 'D05', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'D06', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'E05', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'E06', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi1', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'F07', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'F08', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'INACTIVE', 'amberf', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'F11', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'F12', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'G06', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'G07', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'G08', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'G09', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'INACTIVE', 'amberf', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'H04', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'H05', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'H06', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'H07', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'H08', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'H09', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'J04', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'J05', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi1', '', 'J06', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi1', '', 'J07', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi1', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'B10', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'B11', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'INACTIVE', 'amberf', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'C05', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'C06', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi2', '', 'D05', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'D06', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'E05', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'E06', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi2', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'F07', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'F08', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'INACTIVE', 'amberf', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'F11', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'F12', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'SPARE', 'grayf', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'G06', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'G07', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'G08', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'G09', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'INACTIVE', 'amberf', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'H04', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'H05', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'H06', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'H07', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'H08', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'H09', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'J04', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'J05', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
newtext('mdsdpcdigi2', '', 'J06', 'bluef', 'smallf', 'center')
newtext('mdsdpcdigi2', '', 'J07', 'bluef', 'smallf', 'center', 'borderleft')
newtext('mdsdpcdigi2', '', 'ACTIVE', 'whitef', 'smallf', 'borderleft')
...
newtext('mdsdpcdigi3', '', 'DU ROB', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'ENG 2 EEC CH A', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'MMR-2 ILS', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'FQPU TANK 2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'WXR 1-02-F0', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'IASC PFTC-R', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'TBMU', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'SMYDC-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'PSEU SYS-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'DME-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'P61 MECH SEL', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'TERRAIN 2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'MFP-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'APU ECU', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'VOR-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'EFIS CP F0', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'DFDAU', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'ADF-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'FCC-R', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'TCAS-2', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', '--', 'bluef', 'smallf')
newtext('mdsdpcdigi3', '', 'ADR-R-4/ADR-R-2', 'bluef', 'smallf')
...
fillerf()
displaybuttonf('PREV PAGE', 'mdspg7prevpage')
displaybuttonf('NEXT PAGE', 'mdspg7nextpage')
displayT()
}
